...
class UsuarioService:
    def __init__(self, usuario_repository: UsuarioRepository, email_service: EmailService):
    ...
    def eliminar_usuario(self, id: int):
        ...
        if usuario_a_eliminar:
            ...
            print(f"Advertencia: No se encontró usuario con ID {id} para eliminar.")
    ...
    def autenticar_usuario(self, username_or_email: str, password: str) -> Optional[Usuario]:
